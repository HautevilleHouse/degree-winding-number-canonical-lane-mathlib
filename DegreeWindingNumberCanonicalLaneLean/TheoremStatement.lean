import DegreeWindingNumberCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "degree-winding-number-canonical-lane"
def sourceDescription : String := "Degree Winding Number — Number Theory"
def sourceTheoremBoundary : { claimBoundary : String } := { claimBoundary := "classical boundary carried" }
